...
-- TR: Genel teslimat performansını özetleyen KPI VIEW.
--     Toplam sipariş, zamanında teslimat, geciken sipariş ve on-time oranını içerir.
--
-- EN: KPI view summarizing overall delivery performance.
--     Includes total orders, on-time orders, late orders, and on-time rate.
...
-- TR: En çok sipariş alan ilk 10 ürün profilini raporlama amacıyla sunan VIEW.
--     Ürün profili; ürün önemi, maliyet bandı, ağırlık bandı ve indirim bandı birleşiminden oluşur.
--
-- EN: Reporting view showing top 10 most ordered product profiles.
--     Product profile is derived from product importance, cost band, weight band, and discount band.
...
-- TR: Gönderim moduna göre toplam sipariş ve zamanında teslimat oranını sunan VIEW.
--     Power BI bar chart'larında gönderim yöntemlerinin performansını karşılaştırmak için kullanılır.
--
-- EN: Reporting view for delivery performance by shipment mode.
--     Used in bar charts to compare shipment method efficiency.
...
-- TR: Depo bloklarına göre teslimat performansını raporlama amacıyla sunan VIEW.
--     Operasyonel gecikmelerin depo bazlı kaynaklarını analiz etmek için kullanılır.
--
-- EN: Reporting view for delivery performance by warehouse block.
--     Used to analyze warehouse-level operational delays.
...
-- TR: Ürün önem seviyesine göre teslimat performansını sunan VIEW.
--     Kritik (high importance) ürünlerdeki riskleri analiz etmek için kullanılır.
--
-- EN: Reporting view for delivery performance by product importance.
--     Used to analyze risks associated with high-importance products.
